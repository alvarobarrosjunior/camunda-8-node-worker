...
declare class TTaskState {
    COMPLETED: LiteralObject;
    CREATED: LiteralObject;
    CANCELED: LiteralObject;
}
export declare const TaskState: TTaskState;
...
export interface TaskWithVariables<T = {
    [key: string]: any;
}> extends TaskBase {
    variables: T;
}

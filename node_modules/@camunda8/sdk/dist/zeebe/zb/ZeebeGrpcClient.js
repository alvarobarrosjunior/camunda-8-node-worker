...
class ZeebeGrpcClient extends TypedEmitter_1.TypedEmitter {
    constructor(options) {
        ...
        this.gatewayAddress = (0, lib_1.RequireConfiguration)(config.ZEEBE_ADDRESS || config.ZEEBE_GRPC_ADDRESS, 'ZEEBE_GRPC_ADDRESS');
    ...
    activateJobs(request) {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                stream.on('data', (res) => {
                    res.jobs.forEach((job) => (0, lib_2.parseVariablesAndCustomHeadersToJSON)(job, inputVariableDtoToUse, customHeadersDtoToUse)
                        .then((parsedJob) => jobs.push(parsedJob))
                        .catch((e) => this.failJob({
                        jobKey: job.key,

        ...
        for (const key in listMethods) {
            if (listMethods[key]) {
                ...
                this[`${methodName}Stream`] = async (data) => {
                    ...
                    const clientsideTimeoutDuration = typed_duration_1.Duration.milliseconds.from(timeNormalisedRequest.requestTimeout ?? this.longPoll) + 1000;
                    ...
                    const clientSideTimeout = timeNormalisedRequest.requestTimeout !== 0 &&
                        timeNormalisedRequest.requestTimeout !== -1
                        ? setTimeout(() => {
                            if (clientsideTimeoutDuration !== 1000 &&
